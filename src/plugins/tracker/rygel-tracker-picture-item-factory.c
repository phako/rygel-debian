/* rygel-tracker-picture-item-factory.c generated by valac, the Vala compiler
...
static RygelMediaItem* rygel_tracker_picture_item_factory_real_create (RygelTrackerItemFactory* base, const char* id, const char* uri, RygelTrackerSearchContainer* parent, char** metadata, int metadata_length1, GError** error);
...
RygelTrackerPictureItemFactory* rygel_tracker_picture_item_factory_construct (GType object_type) {
#line 157 "rygel-tracker-picture-item-factory.c"
	RygelTrackerPictureItemFactory* self;
	GeeArrayList* _tmp2_;
	GeeArrayList* _tmp3_;
#line 40 "rygel-tracker-picture-item-factory.vala"
	self = (RygelTrackerPictureItemFactory*) rygel_tracker_item_factory_construct (object_type, RYGEL_TRACKER_PICTURE_ITEM_FACTORY_CATEGORY, RYGEL_MEDIA_ITEM_PHOTO_CLASS, RYGEL_PHOTO_RESOURCES_CLASS_PATH, g_get_user_special_dir (G_USER_DIRECTORY_PICTURES));
#line 163 "rygel-tracker-picture-item-factory.c"
	{
		gint i;
#line 45 "rygel-tracker-picture-item-factory.vala"
		i = gee_collection_get_size ((GeeCollection*) ((RygelTrackerItemFactory*) self)->key_chains);
#line 168 "rygel-tracker-picture-item-factory.c"
		{
			gboolean _tmp0_;
#line 45 "rygel-tracker-picture-item-factory.vala"
			_tmp0_ = TRUE;
#line 45 "rygel-tracker-picture-item-factory.vala"
			while (TRUE) {
#line 175 "rygel-tracker-picture-item-factory.c"
				GeeArrayList* _tmp1_;
#line 45 "rygel-tracker-picture-item-factory.vala"
				if (!_tmp0_) {
#line 45 "rygel-tracker-picture-item-factory.vala"
					i++;
#line 181 "rygel-tracker-picture-item-factory.c"
				}
#line 45 "rygel-tracker-picture-item-factory.vala"
				_tmp0_ = FALSE;
#line 45 "rygel-tracker-picture-item-factory.vala"
				if (!(i < RYGEL_TRACKER_PICTURE_ITEM_FACTORY_PICTURE_METADATA_LAST_KEY)) {
#line 45 "rygel-tracker-picture-item-factory.vala"
					break;
#line 189 "rygel-tracker-picture-item-factory.c"
				}
#line 46 "rygel-tracker-picture-item-factory.vala"
...
#line 193 "rygel-tracker-picture-item-factory.c"
				_g_object_unref0 (_tmp1_);
			}
		}
	}
#line 49 "rygel-tracker-picture-item-factory.vala"
	gee_abstract_collection_add ((GeeAbstractCollection*) (_tmp2_ = (GeeArrayList*) gee_abstract_list_get ((GeeAbstractList*) ((RygelTrackerItemFactory*) self)->key_chains, (gint) RYGEL_TRACKER_PICTURE_ITEM_FACTORY_PICTURE_METADATA_WIDTH)), "nfo:width");
#line 200 "rygel-tracker-picture-item-factory.c"
	_g_object_unref0 (_tmp2_);
#line 50 "rygel-tracker-picture-item-factory.vala"
	gee_abstract_collection_add ((GeeAbstractCollection*) (_tmp3_ = (GeeArrayList*) gee_abstract_list_get ((GeeAbstractList*) ((RygelTrackerItemFactory*) self)->key_chains, (gint) RYGEL_TRACKER_PICTURE_ITEM_FACTORY_PICTURE_METADATA_HEIGHT)), "nfo:height");
...
#line 53 "rygel-tracker-picture-item-factory.vala"
static RygelMediaItem* rygel_tracker_picture_item_factory_real_create (RygelTrackerItemFactory* base, const char* id, const char* uri, RygelTrackerSearchContainer* parent, char** metadata, int metadata_length1, GError** error) {
#line 220 "rygel-tracker-picture-item-factory.c"
	RygelTrackerPictureItemFactory * self;
...
#line 232 "rygel-tracker-picture-item-factory.c"
	_inner_error_ = NULL;
#line 58 "rygel-tracker-picture-item-factory.vala"
	item = RYGEL_TRACKER_ITEM_FACTORY_CLASS (rygel_tracker_picture_item_factory_parent_class)->create (RYGEL_TRACKER_ITEM_FACTORY (self), id, uri, parent, metadata, metadata_length1, &_inner_error_);
#line 236 "rygel-tracker-picture-item-factory.c"
	if (_inner_error_ != NULL) {
		g_propagate_error (error, _inner_error_);
		return NULL;
	}
#line 60 "rygel-tracker-picture-item-factory.vala"
	if (_vala_strcmp0 (metadata[RYGEL_TRACKER_PICTURE_ITEM_FACTORY_PICTURE_METADATA_WIDTH], "") != 0) {
#line 61 "rygel-tracker-picture-item-factory.vala"
		item->width = atoi (metadata[RYGEL_TRACKER_PICTURE_ITEM_FACTORY_PICTURE_METADATA_WIDTH]);
#line 245 "rygel-tracker-picture-item-factory.c"
	}
#line 63 "rygel-tracker-picture-item-factory.vala"
	if (_vala_strcmp0 (metadata[RYGEL_TRACKER_PICTURE_ITEM_FACTORY_PICTURE_METADATA_HEIGHT], "") != 0) {
#line 64 "rygel-tracker-picture-item-factory.vala"
		item->height = atoi (metadata[RYGEL_TRACKER_PICTURE_ITEM_FACTORY_PICTURE_METADATA_HEIGHT]);
#line 251 "rygel-tracker-picture-item-factory.c"
	}
	result = item;
#line 66 "rygel-tracker-picture-item-factory.vala"
	return result;
#line 256 "rygel-tracker-picture-item-factory.c"
}
