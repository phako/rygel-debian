...
#line 37 "rygel-tracker-pictures.vala"
...
#line 38 "rygel-tracker-pictures.vala"
...
RygelTrackerPictures* rygel_tracker_pictures_new (const char* id, RygelMediaContainer* parent, const char* title) {
#line 32 "rygel-tracker-pictures.vala"
	return rygel_tracker_pictures_construct (RYGEL_TYPE_TRACKER_PICTURES, id, parent, title);
...
GType rygel_tracker_pictures_get_type (void) {
	...
	if (g_once_init_enter (&rygel_tracker_pictures_type_id__volatile)) {
		...
		rygel_tracker_pictures_type_id = g_type_register_static (RYGEL_TYPE_TRACKER_CATEGORY_CONTAINER, "RygelTrackerPictures", &g_define_type_info, 0);
