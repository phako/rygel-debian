...
RygelTrackerSelectionQuery* rygel_tracker_selection_query_construct (GType object_type, GeeArrayList* variables, RygelTrackerQueryTriplets* triplets, GeeArrayList* filters, const char* order_by, gint offset, gint max_count) {
#line 184 "rygel-tracker-selection-query.c"
	RygelTrackerSelectionQuery* self;
	GeeArrayList* _tmp2_;
	char* _tmp3_;
#line 38 "rygel-tracker-selection-query.vala"
...
#line 44 "rygel-tracker-selection-query.vala"
	self = (RygelTrackerSelectionQuery*) rygel_tracker_query_construct (object_type, triplets);
#line 46 "rygel-tracker-selection-query.vala"
	if (filters != NULL) {
...
#line 200 "rygel-tracker-selection-query.c"
	} else {
		GeeArrayList* _tmp1_;
#line 49 "rygel-tracker-selection-query.vala"
...
#line 52 "rygel-tracker-selection-query.vala"
...
#line 215 "rygel-tracker-selection-query.c"
	return self;
}
...
#line 224 "rygel-tracker-selection-query.c"
}


#line 58 "rygel-tracker-selection-query.vala"
RygelTrackerSelectionQuery* rygel_tracker_selection_query_construct_clone (GType object_type, RygelTrackerSelectionQuery* query) {
#line 230 "rygel-tracker-selection-query.c"
	RygelTrackerSelectionQuery* self;
	GeeArrayList* _tmp2_;
...
#line 59 "rygel-tracker-selection-query.vala"
	self = (RygelTrackerSelectionQuery*) rygel_tracker_selection_query_construct (object_type, _tmp0_ = rygel_tracker_selection_query_copy_str_list ((GeeList*) query->variables), _tmp1_ = rygel_tracker_query_triplets_new_clone (((RygelTrackerQuery*) query)->triplets), _tmp2_ = rygel_tracker_selection_query_copy_str_list ((GeeList*) query->filters), query->order_by, query->offset, query->max_count);
#line 239 "rygel-tracker-selection-query.c"
...
#line 251 "rygel-tracker-selection-query.c"
}
...
#line 71 "rygel-tracker-selection-query.vala"
		g_debug (_ ("Executing SPARQL query: %s"), data->str);
#line 308 "rygel-tracker-selection-query.c"
		data->_state_ = 7;
...
#line 337 "rygel-tracker-selection-query.c"
		_g_free0 (data->str);
	}
	{
		if (data->_state_ == 0) {
...
#line 76 "rygel-tracker-selection-query.vala"
static char* rygel_tracker_selection_query_real_to_string (RygelTrackerQuery* base) {
#line 354 "rygel-tracker-selection-query.c"
	RygelTrackerSelectionQuery * self;
	char* result = NULL;
	char* query;
	char* _tmp4_;
	...
	char* _tmp14_;
	self = (RygelTrackerSelectionQuery*) base;
#line 77 "rygel-tracker-selection-query.vala"
	query = g_strdup ("SELECT ");
#line 368 "rygel-tracker-selection-query.c"
	{
...
#line 79 "rygel-tracker-selection-query.vala"
		while (TRUE) {
#line 374 "rygel-tracker-selection-query.c"
			char* variable;
			char* _tmp1_;
			char* _tmp0_;
#line 79 "rygel-tracker-selection-query.vala"
...
#line 79 "rygel-tracker-selection-query.vala"
				break;
#line 382 "rygel-tracker-selection-query.c"
			}
#line 79 "rygel-tracker-selection-query.vala"
			variable = (char*) gee_iterator_get (_variable_it);
#line 80 "rygel-tracker-selection-query.vala"
			query = (_tmp1_ = g_strconcat (query, _tmp0_ = g_strconcat (" ", variable, NULL), NULL), _g_free0 (query), _tmp1_);
#line 388 "rygel-tracker-selection-query.c"
			_g_free0 (_tmp0_);
			_g_free0 (variable);
		}
		_g_object_unref0 (_variable_it);
	}
#line 83 "rygel-tracker-selection-query.vala"
...
#line 87 "rygel-tracker-selection-query.vala"
				while (TRUE) {
#line 418 "rygel-tracker-selection-query.c"
					char* _tmp8_;
					char* _tmp7_;
#line 87 "rygel-tracker-selection-query.vala"
					if (!_tmp6_) {
#line 87 "rygel-tracker-selection-query.vala"
						i++;
#line 425 "rygel-tracker-selection-query.c"
					}
#line 87 "rygel-tracker-selection-query.vala"
					_tmp6_ = FALSE;
#line 87 "rygel-tracker-selection-query.vala"
...
#line 87 "rygel-tracker-selection-query.vala"
						break;
#line 433 "rygel-tracker-selection-query.c"
					}
...
#line 437 "rygel-tracker-selection-query.c"
					_g_free0 (_tmp7_);
#line 90 "rygel-tracker-selection-query.vala"
					if (i < (gee_collection_get_size ((GeeCollection*) self->filters) - 1)) {
#line 441 "rygel-tracker-selection-query.c"
						char* _tmp9_;
#line 91 "rygel-tracker-selection-query.vala"
						query = (_tmp9_ = g_strconcat (query, " && ", NULL), _g_free0 (query), _tmp9_);
#line 445 "rygel-tracker-selection-query.c"
					}
				}
			}
		}
#line 94 "rygel-tracker-selection-query.vala"
		query = (_tmp10_ = g_strconcat (query, ")", NULL), _g_free0 (query), _tmp10_);
#line 452 "rygel-tracker-selection-query.c"
	}
#line 97 "rygel-tracker-selection-query.vala"
...
#line 458 "rygel-tracker-selection-query.c"
		char* _tmp13_;
		char* _tmp12_;
#line 100 "rygel-tracker-selection-query.vala"
		query = (_tmp13_ = g_strconcat (query, _tmp12_ = g_strconcat (" ORDER BY ", self->order_by, NULL), NULL), _g_free0 (query), _tmp13_);
#line 463 "rygel-tracker-selection-query.c"
		_g_free0 (_tmp12_);
	}
#line 103 "rygel-tracker-selection-query.vala"
...
#line 468 "rygel-tracker-selection-query.c"
	_g_free0 (_tmp15_);
	_g_free0 (_tmp14_);
#line 105 "rygel-tracker-selection-query.vala"
	if (self->max_count != (-1)) {
#line 473 "rygel-tracker-selection-query.c"
		char* _tmp19_;
		char* _tmp18_;
		char* _tmp17_;
#line 106 "rygel-tracker-selection-query.vala"
...
#line 479 "rygel-tracker-selection-query.c"
		_g_free0 (_tmp18_);
		_g_free0 (_tmp17_);
	}
	result = query;
#line 109 "rygel-tracker-selection-query.vala"
	return result;
#line 486 "rygel-tracker-selection-query.c"
}


#line 112 "rygel-tracker-selection-query.vala"
static GeeArrayList* rygel_tracker_selection_query_copy_str_list (GeeList* str_list) {
#line 492 "rygel-tracker-selection-query.c"
	GeeArrayList* result = NULL;
	GeeArrayList* copy;
#line 112 "rygel-tracker-selection-query.vala"
	g_return_val_if_fail (str_list != NULL, NULL);
#line 113 "rygel-tracker-selection-query.vala"
...
#line 501 "rygel-tracker-selection-query.c"
	result = copy;
#line 117 "rygel-tracker-selection-query.vala"
	return result;
#line 505 "rygel-tracker-selection-query.c"
}
