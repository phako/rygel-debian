...
#line 316 "rygel-media-art-store.c"
...
#line 355 "rygel-media-art-store.c"
	_inner_error_ = NULL;
...
#line 60 "rygel-media-art-store.vala"
	file = NULL;
#line 360 "rygel-media-art-store.c"
	{
...
#line 367 "rygel-media-art-store.c"
...
#line 71 "rygel-media-art-store.vala"
	if (file == NULL) {
#line 395 "rygel-media-art-store.c"
		result = NULL;
...
#line 405 "rygel-media-art-store.c"
	if (_inner_error_ != NULL) {
...
#line 414 "rygel-media-art-store.c"
		result = NULL;
...
#line 80 "rygel-media-art-store.vala"
		return result;
#line 421 "rygel-media-art-store.c"
	}
...
#line 429 "rygel-media-art-store.c"
...
#line 87 "rygel-media-art-store.vala"
	return result;
#line 436 "rygel-media-art-store.c"
}


#line 90 "rygel-media-art-store.vala"
RygelThumbnail* rygel_media_art_store_find_media_art_any (RygelMediaArtStore* self, RygelMediaItem* item, GError** error) {
#line 442 "rygel-media-art-store.c"
	RygelThumbnail* result = NULL;
	GError * _inner_error_;
...
#line 90 "rygel-media-art-store.vala"
	g_return_val_if_fail (item != NULL, NULL);
#line 450 "rygel-media-art-store.c"
	_inner_error_ = NULL;
...
#line 92 "rygel-media-art-store.vala"
	if (thumb == NULL) {
#line 461 "rygel-media-art-store.c"
...
#line 466 "rygel-media-art-store.c"
		if (_inner_error_ != NULL) {
			g_propagate_error (error, _inner_error_);
...
#line 474 "rygel-media-art-store.c"
	}
	result = thumb;
#line 96 "rygel-media-art-store.vala"
	return result;
#line 479 "rygel-media-art-store.c"
}
...
#line 99 "rygel-media-art-store.vala"
	g_return_val_if_fail (item != NULL, NULL);
#line 497 "rygel-media-art-store.c"
	hash = NULL;
	suffix = NULL;
#line 105 "rygel-media-art-store.vala"
	if (simple) {
#line 502 "rygel-media-art-store.c"
		char* _tmp0_;
		char* _tmp1_;
...
#line 509 "rygel-media-art-store.c"
	} else {
		char* _tmp2_;
		char* _tmp3_;
...
#line 517 "rygel-media-art-store.c"
	}
...
#line 523 "rygel-media-art-store.c"
...
static RygelMediaArtStore* rygel_media_art_store_construct (GType object_type, GError** error) {
#line 547 "rygel-media-art-store.c"
	GError * _inner_error_;
...
#line 124 "rygel-media-art-store.vala"
	if (!g_file_query_exists (file, NULL)) {
#line 562 "rygel-media-art-store.c"
		char* message;
...
#line 644 "rygel-media-art-store.c"
		if (_inner_error_ != NULL) {
			_g_free0 (regex_string);
			if (_inner_error_->domain == G_REGEX_ERROR) {
				goto __catch45_g_regex_error;
...
#line 661 "rygel-media-art-store.c"
		{
...
#line 687 "rygel-media-art-store.c"
					if (_inner_error_ != NULL) {
						_g_free0 (block_re);
						_g_free0 (regex_string);
						if (_inner_error_->domain == G_REGEX_ERROR) {
...
#line 704 "rygel-media-art-store.c"
					_g_free0 (block_re);
				}
			}
		}
...
#line 720 "rygel-media-art-store.c"
			_g_error_free0 (_error_);
		}
	}
	__finally45:
...
#line 750 "rygel-media-art-store.c"
}
...
#line 157 "rygel-media-art-store.vala"
			break;
#line 785 "rygel-media-art-store.c"
		}
...
#line 807 "rygel-media-art-store.c"
			_g_free0 (_tmp3_);
			_g_free0 (_tmp2_);
#line 164 "rygel-media-art-store.vala"
			break;
#line 812 "rygel-media-art-store.c"
		}
...
static char* rygel_media_art_store_get_hash (RygelMediaArtStore* self, const char* type, RygelMediaItem* item) {
#line 852 "rygel-media-art-store.c"
	char* result = NULL;
	char* b;
	char* c;
	GQuark _tmp10_;
...
#line 178 "rygel-media-art-store.vala"
	c = NULL;
#line 873 "rygel-media-art-store.c"
	_tmp9_ = type;
...
#line 184 "rygel-media-art-store.vala"
			break;
#line 895 "rygel-media-art-store.c"
		}
...
#line 189 "rygel-media-art-store.vala"
			break;
#line 909 "rygel-media-art-store.c"
		}
...
#line 194 "rygel-media-art-store.vala"
			break;
#line 923 "rygel-media-art-store.c"
		}
	}
...
static char* rygel_media_art_store_normalize_and_hash (RygelMediaArtStore* self, const char* input, gboolean utf8_only) {
#line 937 "rygel-media-art-store.c"
	char* result = NULL;
	char* normalized;
...
#line 949 "rygel-media-art-store.c"
	} else {
#line 202 "rygel-media-art-store.vala"
		_tmp0_ = FALSE;
...
#line 973 "rygel-media-art-store.c"
		}
...
static char* rygel_media_art_store_strip_invalid_entities (RygelMediaArtStore* self, const char* original) {
#line 994 "rygel-media-art-store.c"
	char* result = NULL;
	GError * _inner_error_;
	char* p;
	char* _tmp0_;
...
#line 1008 "rygel-media-art-store.c"
	{
		char* _tmp3_;
		char* _tmp4_;
		char* _tmp5_;
...
#line 1022 "rygel-media-art-store.c"
...
#line 1067 "rygel-media-art-store.c"
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == G_REGEX_ERROR) {
				goto __catch46_g_regex_error;
			}
...
#line 1081 "rygel-media-art-store.c"
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == G_REGEX_ERROR) {
				goto __catch46_g_regex_error;
			}
...
#line 1093 "rygel-media-art-store.c"
		result = p;
#line 229 "rygel-media-art-store.vala"
		return result;
#line 1097 "rygel-media-art-store.c"
	}
	goto __finally46;
...
#line 231 "rygel-media-art-store.vala"
			g_assert_not_reached ();
#line 1108 "rygel-media-art-store.c"
			_g_error_free0 (_error_);
		}
	}
	__finally46:
