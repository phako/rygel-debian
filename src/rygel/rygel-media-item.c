...
#line 560 "rygel-media-item.c"
			}
#line 151 "rygel-media-item.vala"
			if (_tmp2_) {
#line 564 "rygel-media-item.c"
...
#line 705 "rygel-media-item.c"
			result = g_strdup ("internal");
			_g_free0 (scheme);
#line 216 "rygel-media-item.vala"
			return result;
#line 710 "rygel-media-item.c"
		} else {
