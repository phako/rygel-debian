/* rygel-subtitle.c generated by valac, the Vala compiler
...
#line 37 "rygel-subtitle.vala"
RygelSubtitle* rygel_subtitle_construct (GType object_type, const char* mime_type, const char* caption_type) {
#line 93 "rygel-subtitle.c"
	RygelSubtitle* self;
	char* _tmp0_;
	char* _tmp1_;
#line 37 "rygel-subtitle.vala"
...
#line 101 "rygel-subtitle.c"
	self = (RygelSubtitle*) g_type_create_instance (object_type);
#line 39 "rygel-subtitle.vala"
	self->mime_type = (_tmp0_ = g_strdup (mime_type), _g_free0 (self->mime_type), _tmp0_);
#line 40 "rygel-subtitle.vala"
	self->caption_type = (_tmp1_ = g_strdup (caption_type), _g_free0 (self->caption_type), _tmp1_);
#line 107 "rygel-subtitle.c"
	return self;
}
...
#line 116 "rygel-subtitle.c"
}


#line 43 "rygel-subtitle.vala"
void rygel_subtitle_add_didl_node (RygelSubtitle* self, GUPnPDIDLLiteItem* didl_item) {
#line 122 "rygel-subtitle.c"
	xmlNode* item_node;
	xmlNode* root_node;
	xmlNs* sec_ns;
	xmlNode* sec_node;
...
#line 44 "rygel-subtitle.vala"
	item_node = gupnp_didl_lite_object_get_xml_node ((GUPnPDIDLLiteObject*) didl_item);
#line 45 "rygel-subtitle.vala"
	root_node = xmlDocGetRootElement (item_node->doc);
#line 47 "rygel-subtitle.vala"
	sec_ns = xmlNewNs (root_node, "http://www.sec.co.kr/", "sec");
#line 48 "rygel-subtitle.vala"
	sec_node = xmlNewChild (item_node, sec_ns, "CaptionInfoEx", self->uri);
#line 52 "rygel-subtitle.vala"
	xmlNewProp (sec_node, "sec:type", self->caption_type);
#line 141 "rygel-subtitle.c"
}
