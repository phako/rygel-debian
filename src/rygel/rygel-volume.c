/* rygel-volume.c generated by valac, the Vala compiler
...
#line 27 "rygel-volume.vala"
double rygel_volume_from_percentage (guint percentage) {
#line 87 "rygel-volume.c"
	double result = 0.0;
	result = ((double) percentage) / 100.0;
#line 28 "rygel-volume.vala"
	return result;
#line 92 "rygel-volume.c"
}


#line 31 "rygel-volume.vala"
guint rygel_volume_to_percentage (double volume) {
#line 98 "rygel-volume.c"
	guint result = 0U;
	result = (guint) (volume * 100.0);
#line 32 "rygel-volume.vala"
	return result;
#line 103 "rygel-volume.c"
}


#line 26 "rygel-volume.vala"
RygelVolume* rygel_volume_construct (GType object_type) {
#line 109 "rygel-volume.c"
	RygelVolume* self;
