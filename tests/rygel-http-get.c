...
#line 561 "rygel-http-get.c"
			_g_free0 (data->_tmp6_);
		} else {
#line 59 "rygel-http-get.vala"
			data->_tmp1_ = FALSE;
#line 566 "rygel-http-get.c"
		}
#line 59 "rygel-http-get.vala"
		if (data->_tmp1_) {
#line 59 "rygel-http-get.vala"
			data->_tmp0_ = TRUE;
#line 572 "rygel-http-get.c"
		} else {
#line 60 "rygel-http-get.vala"
			if (data->header != NULL) {
#line 60 "rygel-http-get.vala"
				data->_tmp7_ = _vala_strcmp0 (data->header, "1") != 0;
#line 578 "rygel-http-get.c"
			} else {
#line 60 "rygel-http-get.vala"
				data->_tmp7_ = FALSE;
...
#line 61 "rygel-http-get.vala"
			rygel_http_request_handle_error ((RygelHTTPRequest*) data->self, data->_tmp8_ = g_error_new_literal (RYGEL_HTTP_REQUEST_ERROR, RYGEL_HTTP_REQUEST_ERROR_BAD_REQUEST, _ ("Invalid Request")));
...
#line 70 "rygel-http-get.vala"
				data->self->handler = (data->_tmp9_ = (RygelHTTPGetHandler*) rygel_http_transcode_handler_new (data->transcoder, rygel_state_machine_get_cancellable ((RygelStateMachine*) data->self)), _rygel_http_get_handler_unref0 (data->self->handler), data->_tmp9_);
#line 615 "rygel-http-get.c"
...
#line 74 "rygel-http-get.vala"
				g_warning (_ ("Failed to parse query: %s"), data->err->message);
#line 627 "rygel-http-get.c"
...
#line 78 "rygel-http-get.vala"
			data->self->handler = (data->_tmp10_ = (RygelHTTPGetHandler*) rygel_http_identity_handler_new (rygel_state_machine_get_cancellable ((RygelStateMachine*) data->self)), _rygel_http_get_handler_unref0 (data->self->handler), data->_tmp10_);
...
#line 782 "rygel-http-get.c"
}


#line 106 "rygel-http-get.vala"
static void __lambda3__soup_message_headers_foreach_func (const char* name, const char* value, gpointer self) {
#line 788 "rygel-http-get.c"
...
#line 105 "rygel-http-get.vala"
			g_debug ("rygel-http-get.vala:105: %s", _ ("Following HTTP headers appended to response:"));
#line 106 "rygel-http-get.vala"
