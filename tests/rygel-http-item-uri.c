...
RygelHTTPItemURI* rygel_http_item_uri_construct (GType object_type, const char* item_id, RygelHTTPServer* http_server, gint thumbnail_index, gint subtitle_index, const char* transcode_target) {
#line 126 "rygel-http-item-uri.c"
...
#line 147 "rygel-http-item-uri.c"
	return self;
}
...
#line 156 "rygel-http-item-uri.c"
}


#line 1052 "glib-2.0.vapi"
static char* string_replace (const char* self, const char* old, const char* replacement) {
#line 162 "rygel-http-item-uri.c"
	char* result = NULL;
...
#line 180 "rygel-http-item-uri.c"
...
#line 191 "rygel-http-item-uri.c"
		if (_inner_error_ != NULL) {
...
#line 1055 "glib-2.0.vapi"
		return result;
#line 206 "rygel-http-item-uri.c"
	}
	goto __finally2;
...
#line 217 "rygel-http-item-uri.c"
			_g_error_free0 (e);
		}
	}
	__finally2:
...
RygelHTTPItemURI* rygel_http_item_uri_construct_from_string (GType object_type, const char* uri, RygelHTTPServer* http_server, GError** error) {
#line 232 "rygel-http-item-uri.c"
	GError * _inner_error_;
	RygelHTTPItemURI * self;
	char* _tmp0_;
...
#line 45 "rygel-http-item-uri.vala"
	g_return_val_if_fail (http_server != NULL, NULL);
#line 248 "rygel-http-item-uri.c"
	_inner_error_ = NULL;
#line 45 "rygel-http-item-uri.vala"
	self = (RygelHTTPItemURI*) g_object_new (object_type, NULL);
...
#line 262 "rygel-http-item-uri.c"
...
#line 57 "rygel-http-item-uri.vala"
		_tmp4_ = TRUE;
#line 268 "rygel-http-item-uri.c"
	} else {
#line 57 "rygel-http-item-uri.vala"
...
#line 57 "rygel-http-item-uri.vala"
	if (_tmp4_) {
#line 276 "rygel-http-item-uri.c"
		_inner_error_ = g_error_new (RYGEL_HTTP_REQUEST_ERROR, RYGEL_HTTP_REQUEST_ERROR_BAD_REQUEST, "Invalid URI '%s'", request_uri);
		{
...
#line 62 "rygel-http-item-uri.vala"
		i = 1;
#line 298 "rygel-http-item-uri.c"
		{
			gboolean _tmp5_;
#line 62 "rygel-http-item-uri.vala"
			_tmp5_ = TRUE;
#line 62 "rygel-http-item-uri.vala"
			while (TRUE) {
#line 305 "rygel-http-item-uri.c"
				GQuark _tmp13_;
				const char* _tmp12_;
...
#line 62 "rygel-http-item-uri.vala"
					i = i + 2;
#line 316 "rygel-http-item-uri.c"
				}
#line 62 "rygel-http-item-uri.vala"
				_tmp5_ = FALSE;
#line 62 "rygel-http-item-uri.vala"
...
#line 62 "rygel-http-item-uri.vala"
					break;
#line 324 "rygel-http-item-uri.c"
				}
				_tmp12_ = parts[i];
...
#line 348 "rygel-http-item-uri.c"
						data = (g_free (data), NULL);
						_g_string_free0 (builder);
#line 70 "rygel-http-item-uri.vala"
						break;
#line 353 "rygel-http-item-uri.c"
					}
...
#line 84 "rygel-http-item-uri.vala"
						break;
#line 392 "rygel-http-item-uri.c"
					}
				}
			}
		}
...
#line 400 "rygel-http-item-uri.c"
...
#line 1065 "glib-2.0.vapi"
	g_return_val_if_fail (self != NULL, NULL);
#line 444 "rygel-http-item-uri.c"
...
char* rygel_http_item_uri_to_string (RygelHTTPItemURI* self) {
#line 461 "rygel-http-item-uri.c"
	char* result = NULL;
	gchar* _tmp1_;
	gint _data_size_;
	gint data_length1;
...
#line 93 "rygel-http-item-uri.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 474 "rygel-http-item-uri.c"
...
#line 490 "rygel-http-item-uri.c"
		_g_free0 (_tmp5_);
	} else {
...
#line 501 "rygel-http-item-uri.c"
			_g_free0 (_tmp8_);
			_g_free0 (_tmp7_);
		} else {
...
#line 112 "rygel-http-item-uri.vala"
	return result;
#line 525 "rygel-http-item-uri.c"
}


#line 115 "rygel-http-item-uri.vala"
static char* rygel_http_item_uri_create_uri_for_path (RygelHTTPItemURI* self, const char* path) {
#line 531 "rygel-http-item-uri.c"
	char* result = NULL;
#line 115 "rygel-http-item-uri.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 115 "rygel-http-item-uri.vala"
	g_return_val_if_fail (path != NULL, NULL);
#line 537 "rygel-http-item-uri.c"
...
#line 116 "rygel-http-item-uri.vala"
	return result;
#line 541 "rygel-http-item-uri.c"
}
