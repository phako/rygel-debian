/* rygel-http-item-uri_http-post.c generated by valac, the Vala compiler
...
#line 210 "rygel-http-item-uri_http-post.c"
...
#line 221 "rygel-http-item-uri_http-post.c"
		if (_inner_error_ != NULL) {
...
#line 1159 "glib-2.0.vapi"
		return result;
#line 236 "rygel-http-item-uri_http-post.c"
	}
	goto __finally8;
...
#line 247 "rygel-http-item-uri_http-post.c"
			_g_error_free0 (e);
		}
	}
	__finally8:
...
RygelHTTPItemURI* rygel_http_item_uri_construct_from_string (GType object_type, const char* uri, RygelHTTPServer* http_server, GError** error) {
#line 262 "rygel-http-item-uri_http-post.c"
	GError * _inner_error_;
	RygelHTTPItemURI * self;
	char* _tmp0_;
...
#line 45 "rygel-http-item-uri_http-post.vala"
	g_return_val_if_fail (http_server != NULL, NULL);
#line 278 "rygel-http-item-uri_http-post.c"
	_inner_error_ = NULL;
#line 45 "rygel-http-item-uri_http-post.vala"
	self = (RygelHTTPItemURI*) g_object_new (object_type, NULL);
...
#line 292 "rygel-http-item-uri_http-post.c"
...
#line 57 "rygel-http-item-uri_http-post.vala"
		_tmp4_ = TRUE;
#line 298 "rygel-http-item-uri_http-post.c"
	} else {
#line 57 "rygel-http-item-uri_http-post.vala"
		_tmp4_ = (parts_length1 % 2) == 0;
#line 302 "rygel-http-item-uri_http-post.c"
	}
#line 57 "rygel-http-item-uri_http-post.vala"
	if (_tmp4_) {
#line 306 "rygel-http-item-uri_http-post.c"
...
#line 62 "rygel-http-item-uri_http-post.vala"
		i = 1;
#line 328 "rygel-http-item-uri_http-post.c"
		{
			gboolean _tmp5_;
#line 62 "rygel-http-item-uri_http-post.vala"
			_tmp5_ = TRUE;
#line 62 "rygel-http-item-uri_http-post.vala"
			while (TRUE) {
#line 335 "rygel-http-item-uri_http-post.c"
				GQuark _tmp13_;
				const char* _tmp12_;
...
#line 62 "rygel-http-item-uri_http-post.vala"
					i = i + 2;
#line 346 "rygel-http-item-uri_http-post.c"
				}
#line 62 "rygel-http-item-uri_http-post.vala"
				_tmp5_ = FALSE;
#line 62 "rygel-http-item-uri_http-post.vala"
...
#line 62 "rygel-http-item-uri_http-post.vala"
					break;
#line 354 "rygel-http-item-uri_http-post.c"
				}
				_tmp12_ = parts[i];
...
#line 378 "rygel-http-item-uri_http-post.c"
...
#line 74 "rygel-http-item-uri_http-post.vala"
						break;
#line 394 "rygel-http-item-uri_http-post.c"
					}
...
#line 78 "rygel-http-item-uri_http-post.vala"
						break;
#line 404 "rygel-http-item-uri_http-post.c"
					}
...
#line 82 "rygel-http-item-uri_http-post.vala"
						break;
#line 414 "rygel-http-item-uri_http-post.c"
					}
				} else
				switch (0) {
					default:
...
#line 84 "rygel-http-item-uri_http-post.vala"
						break;
#line 422 "rygel-http-item-uri_http-post.c"
					}
				}
			}
		}
...
#line 430 "rygel-http-item-uri_http-post.c"
...
#line 464 "rygel-http-item-uri_http-post.c"
	gchar* result = NULL;
	gchar* _tmp1_;
...
#line 1169 "glib-2.0.vapi"
	g_return_val_if_fail (self != NULL, NULL);
#line 474 "rygel-http-item-uri_http-post.c"
...
#line 1173 "glib-2.0.vapi"
	return result;
#line 484 "rygel-http-item-uri_http-post.c"
...
char* rygel_http_item_uri_to_string (RygelHTTPItemURI* self) {
#line 491 "rygel-http-item-uri_http-post.c"
	char* result = NULL;
	gchar* _tmp1_;
	gint _data_size_;
	gint data_length1;
...
#line 93 "rygel-http-item-uri_http-post.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 504 "rygel-http-item-uri_http-post.c"
...
#line 512 "rygel-http-item-uri_http-post.c"
		char* _tmp4_;
		char* _tmp6_;
		char* _tmp5_;
...
#line 525 "rygel-http-item-uri_http-post.c"
			char* _tmp9_;
			char* _tmp8_;
			char* _tmp7_;
...
#line 531 "rygel-http-item-uri_http-post.c"
			_g_free0 (_tmp8_);
			_g_free0 (_tmp7_);
		} else {
#line 108 "rygel-http-item-uri_http-post.vala"
			if (self->subtitle_index >= 0) {
#line 537 "rygel-http-item-uri_http-post.c"
				char* _tmp12_;
				char* _tmp11_;
				char* _tmp10_;
...
#line 543 "rygel-http-item-uri_http-post.c"
				_g_free0 (_tmp11_);
				_g_free0 (_tmp10_);
			}
		}
...
static char* rygel_http_item_uri_create_uri_for_path (RygelHTTPItemURI* self, const char* path) {
#line 561 "rygel-http-item-uri_http-post.c"
	char* result = NULL;
#line 115 "rygel-http-item-uri_http-post.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 115 "rygel-http-item-uri_http-post.vala"
	g_return_val_if_fail (path != NULL, NULL);
#line 567 "rygel-http-item-uri_http-post.c"
...
#line 116 "rygel-http-item-uri_http-post.vala"
	return result;
#line 571 "rygel-http-item-uri_http-post.c"
}
