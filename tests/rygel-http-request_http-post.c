/* rygel-http-request_http-post.c generated by valac, the Vala compiler
...
#line 46 "rygel-http-request_http-post.vala"
RygelHTTPRequest* rygel_http_request_construct (GType object_type, RygelHTTPServer* http_server, SoupServer* server, SoupMessage* msg) {
#line 285 "rygel-http-request_http-post.c"
	RygelHTTPRequest * self;
	GCancellable* _tmp0_;
...
#line 49 "rygel-http-request_http-post.vala"
	self->http_server = http_server;
#line 50 "rygel-http-request_http-post.vala"
	rygel_state_machine_set_cancellable ((RygelStateMachine*) self, _tmp0_ = g_cancellable_new ());
#line 303 "rygel-http-request_http-post.c"
	_g_object_unref0 (_tmp0_);
#line 51 "rygel-http-request_http-post.vala"
	self->priv->root_container = (_tmp1_ = _rygel_media_object_ref0 (http_server->root_container), _rygel_media_object_unref0 (self->priv->root_container), _tmp1_);
#line 52 "rygel-http-request_http-post.vala"
	self->server = (_tmp2_ = _g_object_ref0 (server), _g_object_unref0 (self->server), _tmp2_);
#line 53 "rygel-http-request_http-post.vala"
	self->msg = (_tmp3_ = _g_object_ref0 (msg), _g_object_unref0 (self->msg), _tmp3_);
#line 311 "rygel-http-request_http-post.c"
	return self;
}
...
static gboolean rygel_http_request_real_run_co (RygelHttpRequestRunData* data) {
	...
	_state_0:
	{
		...
		return FALSE;
		_state_12:
#line 57 "rygel-http-request_http-post.vala"
		rygel_http_request_handle_finish (data->self, data->_res_);
#line 367 "rygel-http-request_http-post.c"
	}
	{
		if (data->_state_ == 0) {
...
#line 62 "rygel-http-request_http-post.vala"
...
#line 431 "rygel-http-request_http-post.c"
		...
		__catch8_g_error:
		{
			...
			{
#line 65 "rygel-http-request_http-post.vala"
				rygel_http_request_handle_error (data->self, data->_error_);
#line 441 "rygel-http-request_http-post.c"
		...
		return FALSE;
		_state_13:
#line 70 "rygel-http-request_http-post.vala"
		rygel_http_request_find_item_finish (data->self, data->_res_);
#line 467 "rygel-http-request_http-post.c"
	}
	{
		if (data->_state_ == 0) {
			g_simple_async_result_complete_in_idle (data->_async_result);
...
#line 60 "rygel-http-request_http-post.vala"
void rygel_http_request_handle (RygelHTTPRequest* self, GAsyncReadyCallback _callback_, gpointer _user_data_) {
#line 60 "rygel-http-request_http-post.vala"
	RYGEL_HTTP_REQUEST_GET_CLASS (self)->handle (self, _callback_, _user_data_);
#line 485 "rygel-http-request_http-post.c"
}
...
#line 493 "rygel-http-request_http-post.c"
}
...
#line 77 "rygel-http-request_http-post.vala"
			data->media_object = (data->_tmp1_ = data->_tmp0_, _rygel_media_object_unref0 (data->media_object), data->_tmp1_);
#line 551 "rygel-http-request_http-post.c"
		}
		goto __finally9;
		__catch9_g_error:
		{
			...
			data->_inner_error_ = NULL;
			{
#line 81 "rygel-http-request_http-post.vala"
				rygel_http_request_handle_error (data->self, data->err);
#line 561 "rygel-http-request_http-post.c"
...
#line 86 "rygel-http-request_http-post.vala"
		if (data->media_object == NULL) {
#line 86 "rygel-http-request_http-post.vala"
			data->_tmp2_ = TRUE;
#line 587 "rygel-http-request_http-post.c"
		} else {
#line 86 "rygel-http-request_http-post.vala"
			data->_tmp2_ = !RYGEL_IS_MEDIA_ITEM (data->media_object);
#line 591 "rygel-http-request_http-post.c"
		}
#line 86 "rygel-http-request_http-post.vala"
		if (data->_tmp2_) {
#line 87 "rygel-http-request_http-post.vala"
...
#line 597 "rygel-http-request_http-post.c"
...
#line 93 "rygel-http-request_http-post.vala"
		data->self->item = (data->_tmp4_ = _rygel_media_object_ref0 (RYGEL_MEDIA_ITEM (data->media_object)), _rygel_media_object_unref0 (data->self->item), data->_tmp4_);
#line 612 "rygel-http-request_http-post.c"
		_rygel_media_object_unref0 (data->media_object);
	}
	{
		if (data->_state_ == 0) {
...
#line 73 "rygel-http-request_http-post.vala"
void rygel_http_request_find_item (RygelHTTPRequest* self, GAsyncReadyCallback _callback_, gpointer _user_data_) {
#line 73 "rygel-http-request_http-post.vala"
	RYGEL_HTTP_REQUEST_GET_CLASS (self)->find_item (self, _callback_, _user_data_);
#line 631 "rygel-http-request_http-post.c"
}
...
#line 639 "rygel-http-request_http-post.c"
}


#line 96 "rygel-http-request_http-post.vala"
static void rygel_http_request_real_handle_error (RygelHTTPRequest* self, GError* _error_) {
#line 645 "rygel-http-request_http-post.c"
	guint status = 0U;
#line 96 "rygel-http-request_http-post.vala"
	g_return_if_fail (self != NULL);
#line 97 "rygel-http-request_http-post.vala"
	g_warning ("rygel-http-request_http-post.vala:97: %s", _error_->message);
#line 100 "rygel-http-request_http-post.vala"
	if (_error_->domain == RYGEL_HTTP_REQUEST_ERROR) {
#line 101 "rygel-http-request_http-post.vala"
		status = (guint) _error_->code;
#line 655 "rygel-http-request_http-post.c"
	} else {
#line 103 "rygel-http-request_http-post.vala"
		status = (guint) SOUP_STATUS_NOT_FOUND;
#line 659 "rygel-http-request_http-post.c"
	}
#line 106 "rygel-http-request_http-post.vala"
...
#line 671 "rygel-http-request_http-post.c"
}


#line 109 "rygel-http-request_http-post.vala"
void rygel_http_request_end (RygelHTTPRequest* self, guint status) {
#line 109 "rygel-http-request_http-post.vala"
	g_return_if_fail (self != NULL);
#line 110 "rygel-http-request_http-post.vala"
	if (status != SOUP_STATUS_NONE) {
#line 111 "rygel-http-request_http-post.vala"
		soup_message_set_status (self->msg, status);
#line 683 "rygel-http-request_http-post.c"
	}
#line 114 "rygel-http-request_http-post.vala"
...
#line 41 "rygel-http-request_http-post.vala"
	return result;
#line 698 "rygel-http-request_http-post.c"
}
