...
RygelHTTPRequest* rygel_http_request_construct (GType object_type, RygelHTTPServer* http_server, SoupServer* server, SoupMessage* msg) {
#line 280 "rygel-http-request_http-post.c"
	RygelHTTPRequest * self;
	GCancellable* _tmp0_;
...
#line 298 "rygel-http-request_http-post.c"
...
#line 306 "rygel-http-request_http-post.c"
	return self;
}
	...
	{
		{
			...
			return FALSE;
			_state_12:
#line 58 "rygel-http-request_http-post.vala"
			rygel_http_request_handle_finish (data->self, data->_res_, &data->_inner_error_);
#line 363 "rygel-http-request_http-post.c"
...
#line 376 "rygel-http-request_http-post.c"
...
#line 67 "rygel-http-request_http-post.vala"
		data->self->uri = (data->_tmp1_ = data->_tmp0_, _g_object_unref0 (data->self->uri), data->_tmp1_);
#line 471 "rygel-http-request_http-post.c"
		data->_state_ = 13;
...
#line 478 "rygel-http-request_http-post.c"
		if (data->_inner_error_ != NULL) {
			g_simple_async_result_set_from_error (data->_async_result, data->_inner_error_);
			g_error_free (data->_inner_error_);
			{
...
#line 66 "rygel-http-request_http-post.vala"
void rygel_http_request_handle (RygelHTTPRequest* self, GAsyncReadyCallback _callback_, gpointer _user_data_) {
#line 66 "rygel-http-request_http-post.vala"
	RYGEL_HTTP_REQUEST_GET_CLASS (self)->handle (self, _callback_, _user_data_);
#line 509 "rygel-http-request_http-post.c"
}
...
#line 517 "rygel-http-request_http-post.c"
}
...
#line 79 "rygel-http-request_http-post.vala"
...
#line 593 "rygel-http-request_http-post.c"
		}
#line 79 "rygel-http-request_http-post.vala"
		if (data->_tmp0_) {
...
#line 85 "rygel-http-request_http-post.vala"
		data->self->item = (data->_tmp1_ = _rygel_media_object_ref0 (RYGEL_MEDIA_ITEM (data->media_object)), _rygel_media_object_unref0 (data->self->item), data->_tmp1_);
#line 616 "rygel-http-request_http-post.c"
		_rygel_media_object_unref0 (data->media_object);
	}
	{
		if (data->_state_ == 0) {
...
#line 635 "rygel-http-request_http-post.c"
}
...
#line 643 "rygel-http-request_http-post.c"
}


#line 88 "rygel-http-request_http-post.vala"
void rygel_http_request_handle_error (RygelHTTPRequest* self, GError* _error_) {
#line 649 "rygel-http-request_http-post.c"
	guint status = 0U;
#line 88 "rygel-http-request_http-post.vala"
	g_return_if_fail (self != NULL);
#line 89 "rygel-http-request_http-post.vala"
	g_warning ("rygel-http-request_http-post.vala:89: %s", _error_->message);
#line 90 "rygel-http-request_http-post.vala"
...
#line 94 "rygel-http-request_http-post.vala"
		status = (guint) _error_->code;
#line 661 "rygel-http-request_http-post.c"
	} else {
#line 96 "rygel-http-request_http-post.vala"
		status = (guint) SOUP_STATUS_NOT_FOUND;
#line 665 "rygel-http-request_http-post.c"
	}
#line 99 "rygel-http-request_http-post.vala"
	rygel_http_request_end (self, status);
#line 669 "rygel-http-request_http-post.c"
}


#line 102 "rygel-http-request_http-post.vala"
void rygel_http_request_end (RygelHTTPRequest* self, guint status) {
#line 102 "rygel-http-request_http-post.vala"
	g_return_if_fail (self != NULL);
#line 103 "rygel-http-request_http-post.vala"
	if (status != SOUP_STATUS_NONE) {
#line 104 "rygel-http-request_http-post.vala"
		soup_message_set_status (self->msg, status);
#line 681 "rygel-http-request_http-post.c"
	}
#line 107 "rygel-http-request_http-post.vala"
	g_signal_emit_by_name ((RygelStateMachine*) self, "completed");
#line 685 "rygel-http-request_http-post.c"
}
...
#line 41 "rygel-http-request_http-post.vala"
	return result;
#line 696 "rygel-http-request_http-post.c"
}
