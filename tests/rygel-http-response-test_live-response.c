...
#line 312 "rygel-http-response-test_live-response.c"
	if (_inner_error_ != NULL) {
		g_propagate_error (error, _inner_error_);
		_g_object_unref0 (self);
		return NULL;
...
RygelHTTPResponseTest* rygel_http_response_test_construct_abort (GType object_type, GError** error) {
#line 324 "rygel-http-response-test_live-response.c"
	GError * _inner_error_;
	RygelHTTPResponseTest * self;
	GCancellable* _tmp0_;
	_inner_error_ = NULL;
...
#line 331 "rygel-http-response-test_live-response.c"
...
static void _rygel_http_response_test_on_message_aborted_rygel_http_server_message_aborted (RygelHTTPServer* _sender, SoupMessage* message, gpointer self) {
#line 360 "rygel-http-response-test_live-response.c"
...
#line 395 "rygel-http-response-test_live-response.c"
	} else {
#line 73 "rygel-http-response-test_live-response.vala"
		self->priv->client_done = TRUE;
#line 399 "rygel-http-response-test_live-response.c"
	}
...
#line 421 "rygel-http-response-test_live-response.c"
}


#line 85 "rygel-http-response-test_live-response.vala"
static RygelHTTPResponse* rygel_http_response_test_real_create_response (RygelHTTPResponseTest* self, SoupMessage* msg, GError** error) {
#line 427 "rygel-http-response-test_live-response.c"
...
#line 452 "rygel-http-response-test_live-response.c"
	}
...
#line 98 "rygel-http-response-test_live-response.vala"
		g_main_loop_quit (self->priv->main_loop);
#line 470 "rygel-http-response-test_live-response.c"
	}
#line 101 "rygel-http-response-test_live-response.vala"
	self->priv->server_done = TRUE;
#line 474 "rygel-http-response-test_live-response.c"
}


#line 96 "rygel-http-response-test_live-response.vala"
static void _rygel_http_response_test_on_response_completed_rygel_state_machine_completed (RygelStateMachine* _sender, gpointer self) {
#line 480 "rygel-http-response-test_live-response.c"
...
#line 501 "rygel-http-response-test_live-response.c"
		if (_inner_error_ != NULL) {
...
#line 509 "rygel-http-response-test_live-response.c"
...
#line 114 "rygel-http-response-test_live-response.vala"
			g_main_loop_quit (self->priv->main_loop);
#line 524 "rygel-http-response-test_live-response.c"
			_g_error_free0 (_error_);
#line 116 "rygel-http-response-test_live-response.vala"
			return;
#line 528 "rygel-http-response-test_live-response.c"
		}
	}
	__finally1:
	if (_inner_error_ != NULL) {
...
#line 550 "rygel-http-response-test_live-response.c"
}


#line 125 "rygel-http-response-test_live-response.vala"
static gboolean rygel_http_response_test_on_timeout (RygelHTTPResponseTest* self) {
#line 556 "rygel-http-response-test_live-response.c"
...
#line 127 "rygel-http-response-test_live-response.vala"
	g_main_loop_quit (self->priv->main_loop);
#line 565 "rygel-http-response-test_live-response.c"
	result = FALSE;
#line 129 "rygel-http-response-test_live-response.vala"
	return result;
#line 569 "rygel-http-response-test_live-response.c"
}
...
static void _rygel_http_server_on_request_aborted_soup_server_request_aborted (SoupServer* _sender, SoupMessage* msg, SoupClientContext* client, gpointer self) {
#line 620 "rygel-http-response-test_live-response.c"
...
#line 684 "rygel-http-response-test_live-response.c"
	return self;
}
...
#line 693 "rygel-http-response-test_live-response.c"
}
...
#line 729 "rygel-http-response-test_live-response.c"
}
...
#line 139 "rygel-http-response-test_live-response.vala"
	return result;
#line 744 "rygel-http-response-test_live-response.c"
}
...
static void _rygel_http_client_on_cancelled_g_cancellable_cancelled (GCancellable* _sender, gpointer self) {
#line 798 "rygel-http-response-test_live-response.c"
...
RygelHTTPClient* rygel_http_client_construct (GType object_type, GUPnPContext* context, const char* uri, gsize total_bytes, gboolean active) {
#line 805 "rygel-http-response-test_live-response.c"
	RygelHTTPClient * self;
	GUPnPContext* _tmp0_;
	SoupMessage* _tmp1_;
#line 187 "rygel-http-response-test_live-response.vala"
...
#line 198 "rygel-http-response-test_live-response.vala"
	if (active) {
#line 827 "rygel-http-response-test_live-response.c"
		GCancellable* _tmp2_;
...
#line 835 "rygel-http-response-test_live-response.c"
	}
	return self;
}
...
#line 845 "rygel-http-response-test_live-response.c"
}
...
static gboolean _rygel_http_client_real_run_co_gsource_func (gpointer self) {
#line 885 "rygel-http-response-test_live-response.c"
	gboolean result;
...
#line 908 "rygel-http-response-test_live-response.c"
	} else {
#line 211 "rygel-http-response-test_live-response.vala"
		_tmp0_ = FALSE;
#line 912 "rygel-http-response-test_live-response.c"
	}
#line 211 "rygel-http-response-test_live-response.vala"
	if (_tmp0_) {
...
static void _lambda1_ (SoupSession* session, SoupMessage* msg, Block2Data* _data2_) {
#line 934 "rygel-http-response-test_live-response.c"
	RygelHTTPClient * self;
	self = _data2_->self;
#line 219 "rygel-http-response-test_live-response.vala"
...
#line 945 "rygel-http-response-test_live-response.c"
}


#line 219 "rygel-http-response-test_live-response.vala"
static void __lambda1__soup_session_callback (SoupSession* session, SoupMessage* msg, gpointer self) {
#line 951 "rygel-http-response-test_live-response.c"
...
#line 995 "rygel-http-response-test_live-response.c"
		data->_state_ = 2;
		return FALSE;
		_state_2:
		;
...
#line 1002 "rygel-http-response-test_live-response.c"
...
#line 1027 "rygel-http-response-test_live-response.c"
}
...
#line 185 "rygel-http-response-test_live-response.vala"
	return result;
#line 1038 "rygel-http-response-test_live-response.c"
}
