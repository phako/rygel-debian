/* rygel-http-response_live-response.c generated by valac, the Vala compiler
 * generated from rygel-http-response_live-response.vala, do not modify */
...
#line 57 "rygel-http-response_live-response.vala"
static void _rygel_http_response_on_cancelled_g_cancellable_cancelled (GCancellable* _sender, gpointer self) {
#line 120 "rygel-http-response_live-response.c"
	rygel_http_response_on_cancelled (self, _sender);
}


#line 34 "rygel-http-response_live-response.vala"
RygelHTTPResponse* rygel_http_response_construct (GType object_type, SoupServer* server, SoupMessage* msg, gboolean partial, GCancellable* cancellable) {
#line 127 "rygel-http-response_live-response.c"
...
#line 38 "rygel-http-response_live-response.vala"
	rygel_http_response_set_server (self, server);
#line 39 "rygel-http-response_live-response.vala"
	self->msg = (_tmp0_ = _g_object_ref0 (msg), _g_object_unref0 (self->msg), _tmp0_);
#line 40 "rygel-http-response_live-response.vala"
	rygel_state_machine_set_cancellable ((RygelStateMachine*) self, cancellable);
#line 42 "rygel-http-response_live-response.vala"
	if (partial) {
#line 43 "rygel-http-response_live-response.vala"
		soup_message_set_status (self->msg, (guint) SOUP_STATUS_PARTIAL_CONTENT);
#line 146 "rygel-http-response_live-response.c"
	} else {
#line 45 "rygel-http-response_live-response.vala"
		soup_message_set_status (self->msg, (guint) SOUP_STATUS_OK);
#line 150 "rygel-http-response_live-response.c"
	}
#line 48 "rygel-http-response_live-response.vala"
	soup_message_body_set_accumulate (self->msg->response_body, FALSE);
#line 50 "rygel-http-response_live-response.vala"
	if (rygel_state_machine_get_cancellable ((RygelStateMachine*) self) != NULL) {
#line 51 "rygel-http-response_live-response.vala"
...
#line 158 "rygel-http-response_live-response.c"
	}
	return self;
}
...
#line 168 "rygel-http-response_live-response.c"
}
...
#line 176 "rygel-http-response_live-response.c"
}
...
#line 58 "rygel-http-response_live-response.vala"
	rygel_http_response_end (self, TRUE, (guint) SOUP_STATUS_CANCELLED);
#line 188 "rygel-http-response_live-response.c"
}


#line 61 "rygel-http-response_live-response.vala"
void rygel_http_response_push_data (RygelHTTPResponse* self, void* data, gsize length) {
#line 61 "rygel-http-response_live-response.vala"
	g_return_if_fail (self != NULL);
#line 62 "rygel-http-response_live-response.vala"
	soup_message_body_append (self->msg->response_body, SOUP_MEMORY_COPY, data, length);
#line 66 "rygel-http-response_live-response.vala"
	soup_server_unpause_message (self->priv->_server, self->msg);
#line 200 "rygel-http-response_live-response.c"
}


#line 69 "rygel-http-response_live-response.vala"
static void rygel_http_response_real_end (RygelHTTPResponse* self, gboolean aborted, guint status) {
#line 69 "rygel-http-response_live-response.vala"
	g_return_if_fail (self != NULL);
#line 70 "rygel-http-response_live-response.vala"
	if (self->run_continue != NULL) {
#line 71 "rygel-http-response_live-response.vala"
		self->run_continue (self->run_continue_target);
#line 212 "rygel-http-response_live-response.c"
	}
#line 74 "rygel-http-response_live-response.vala"
	if (status != SOUP_STATUS_NONE) {
#line 75 "rygel-http-response_live-response.vala"
		soup_message_set_status (self->msg, status);
#line 218 "rygel-http-response_live-response.c"
	}
#line 78 "rygel-http-response_live-response.vala"
	g_signal_emit_by_name ((RygelStateMachine*) self, "completed");
#line 222 "rygel-http-response_live-response.c"
}
...
#line 230 "rygel-http-response_live-response.c"
}
...
#line 27 "rygel-http-response_live-response.vala"
	return result;
#line 240 "rygel-http-response_live-response.c"
}
...
#line 30 "rygel-http-response_live-response.vala"
	return result;
#line 259 "rygel-http-response_live-response.c"
}
