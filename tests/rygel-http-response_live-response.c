...
#line 55 "rygel-http-response_live-response.vala"
static void _rygel_http_response_on_cancelled_g_cancellable_cancelled (GCancellable* _sender, gpointer self) {
#line 117 "rygel-http-response_live-response.c"
	rygel_http_response_on_cancelled (self, _sender);
}


#line 32 "rygel-http-response_live-response.vala"
RygelHTTPResponse* rygel_http_response_construct (GType object_type, SoupServer* server, SoupMessage* msg, gboolean partial, GCancellable* cancellable) {
#line 124 "rygel-http-response_live-response.c"
...
#line 36 "rygel-http-response_live-response.vala"
	rygel_http_response_set_server (self, server);
#line 37 "rygel-http-response_live-response.vala"
...
#line 40 "rygel-http-response_live-response.vala"
	if (partial) {
#line 41 "rygel-http-response_live-response.vala"
		soup_message_set_status (self->msg, (guint) SOUP_STATUS_PARTIAL_CONTENT);
#line 143 "rygel-http-response_live-response.c"
	} else {
#line 43 "rygel-http-response_live-response.vala"
		soup_message_set_status (self->msg, (guint) SOUP_STATUS_OK);
#line 147 "rygel-http-response_live-response.c"
	}
#line 46 "rygel-http-response_live-response.vala"
...
#line 49 "rygel-http-response_live-response.vala"
...
#line 155 "rygel-http-response_live-response.c"
	}
	return self;
}
...
#line 165 "rygel-http-response_live-response.c"
}
...
#line 173 "rygel-http-response_live-response.c"
}
...
#line 56 "rygel-http-response_live-response.vala"
	rygel_http_response_end (self, TRUE, (guint) SOUP_STATUS_CANCELLED);
#line 185 "rygel-http-response_live-response.c"
}


#line 59 "rygel-http-response_live-response.vala"
void rygel_http_response_push_data (RygelHTTPResponse* self, void* data, gsize length) {
#line 59 "rygel-http-response_live-response.vala"
	g_return_if_fail (self != NULL);
#line 60 "rygel-http-response_live-response.vala"
	soup_message_body_append (self->msg->response_body, SOUP_MEMORY_COPY, data, length);
#line 64 "rygel-http-response_live-response.vala"
	soup_server_unpause_message (self->priv->_server, self->msg);
#line 197 "rygel-http-response_live-response.c"
}


#line 67 "rygel-http-response_live-response.vala"
static void rygel_http_response_real_end (RygelHTTPResponse* self, gboolean aborted, guint status) {
#line 67 "rygel-http-response_live-response.vala"
	g_return_if_fail (self != NULL);
#line 68 "rygel-http-response_live-response.vala"
	if (status != SOUP_STATUS_NONE) {
#line 69 "rygel-http-response_live-response.vala"
		soup_message_set_status (self->msg, status);
#line 209 "rygel-http-response_live-response.c"
	}
#line 72 "rygel-http-response_live-response.vala"
	g_signal_emit_by_name ((RygelStateMachine*) self, "completed");
#line 213 "rygel-http-response_live-response.c"
}
...
#line 221 "rygel-http-response_live-response.c"
}
...
#line 27 "rygel-http-response_live-response.vala"
	return result;
#line 231 "rygel-http-response_live-response.c"
}
...
#line 30 "rygel-http-response_live-response.vala"
	return result;
#line 250 "rygel-http-response_live-response.c"
}
