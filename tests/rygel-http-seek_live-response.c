/* rygel-http-seek_live-response.c generated by valac, the Vala compiler
 * generated from rygel-http-seek_live-response.vala, do not modify */
...
#line 38 "rygel-http-seek_live-response.vala"
RygelHTTPSeek* rygel_http_seek_construct (GType object_type, SoupMessage* msg, gint64 start, gint64 stop, gint64 total_length) {
#line 108 "rygel-http-seek_live-response.c"
	RygelHTTPSeek * self;
#line 38 "rygel-http-seek_live-response.vala"
	g_return_val_if_fail (msg != NULL, NULL);
#line 38 "rygel-http-seek_live-response.vala"
	self = (RygelHTTPSeek*) g_object_new (object_type, NULL);
#line 42 "rygel-http-seek_live-response.vala"
	rygel_http_seek_set_msg (self, msg);
#line 43 "rygel-http-seek_live-response.vala"
	rygel_http_seek_set_start (self, start);
#line 44 "rygel-http-seek_live-response.vala"
	rygel_http_seek_set_stop (self, stop);
#line 45 "rygel-http-seek_live-response.vala"
	rygel_http_seek_set_total_length (self, total_length);
#line 47 "rygel-http-seek_live-response.vala"
	if (self->priv->_length > 0) {
#line 48 "rygel-http-seek_live-response.vala"
		rygel_http_seek_set_stop (self, CLAMP (stop, start + 1, self->priv->_length - 1));
#line 126 "rygel-http-seek_live-response.c"
	}
#line 51 "rygel-http-seek_live-response.vala"
	rygel_http_seek_set_length (self, (stop + 1) - start);
#line 130 "rygel-http-seek_live-response.c"
	return self;
}


#line 54 "rygel-http-seek_live-response.vala"
static void rygel_http_seek_real_add_response_headers (RygelHTTPSeek* self) {
#line 137 "rygel-http-seek_live-response.c"
...
#line 148 "rygel-http-seek_live-response.c"
}
...
#line 30 "rygel-http-seek_live-response.vala"
	return result;
#line 158 "rygel-http-seek_live-response.c"
}
...
#line 33 "rygel-http-seek_live-response.vala"
	return result;
#line 181 "rygel-http-seek_live-response.c"
}
...
#line 34 "rygel-http-seek_live-response.vala"
	return result;
#line 198 "rygel-http-seek_live-response.c"
}
...
#line 35 "rygel-http-seek_live-response.vala"
	return result;
#line 215 "rygel-http-seek_live-response.c"
}
...
#line 36 "rygel-http-seek_live-response.vala"
	return result;
#line 232 "rygel-http-seek_live-response.c"
}
